...
const projectsFuseOptions: Fuse.IFuseOptions<IJob> = {
    shouldSort: true,
    threshold: 0.4,
    keys: ["name"]
};
...
class ProjectsRenderer extends React.Component<IProjectsRendererProps, IProjectsRendererState> {
    ...
    render() {
        let projects: IJob[] = this.props.projects;
    ...
    onProjectClick(project: IJob) {
        this.props.routeProps.history.push(project.epikinsJobURL);
    }
}
